...
const ENDPOINT = '/api/v1/ideogram_v3/remixes';

export class Remixes {
  constructor(private readonly http: HttpClient) {}

  async run(params: RemixParams, options?: RequestOptions & PollingOptions): Promise<CompletedIdeogramV3Response> {
  ...
  async create(params: RemixParams, options?: RequestOptions): Promise<TaskCreateResponse> {
