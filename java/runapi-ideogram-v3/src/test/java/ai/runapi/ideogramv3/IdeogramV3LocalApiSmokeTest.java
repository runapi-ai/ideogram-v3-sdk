...
import ai.runapi.ideogramv3.types.TextToImageResponse;
    ...
    class IdeogramV3LocalApiSmokeTest {
      ...
      void startServer() throws IOException {
        ...
        server.createContext("/api/v1/ideogram_v3/text_to_image", this::handleRequest);
        server.start();
      }
      ...
      void runUsesApacheTransportAgainstLocalApi() throws Exception {
        try (IdeogramV3Client client =
            IdeogramV3Client.builder()
                .apiKey("sk-test")
      ...
      CompletedTextToImageResponse response =
        ...
        assertEquals("/api/v1/ideogram_v3/text_to_image", create.path);
      ...
      private void handleRequest(HttpExchange exchange) throws IOException {
        ...
        assertEquals("/api/v1/ideogram_v3/text_to_image/task_local_123", captured.path);
